...
booking_avro_serializer = AvroSerializer(schema_registry_client=SchemaRegistryClient(schema_registry_local),
                                         schema_str=booking_schema)

conference_avro_serializer = AvroSerializer(schema_registry_client=SchemaRegistryClient(schema_registry_local),
                                            schema_str=conference_schema)
...
async def bookings(data: AblyWebhook, request: Request):
    try:
